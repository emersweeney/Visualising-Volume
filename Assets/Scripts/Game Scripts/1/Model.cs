...
public class Model : Subject
{
    ...
    public void setStartDragScale(Vector3 scale){this.startDragScale = scale;}
    public void setCameraZDistance(float zDistance){this.cameraZDistance = zDistance;}
    ...
    public void notify(){
        foreach (Observer o in observers){o.notifyMe(new List<Vector3>{newMainPosition, newWaterPosition, newMainScale, newWaterScale});}
    }
